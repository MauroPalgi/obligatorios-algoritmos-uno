...
public class juegosTest {
    ...
    public static void pruebasRegistroClientes(Obligatorio s, Prueba p) {
        p.ver(s.agregarCliente("Micaela Pérez", "111", 99368826, "Lorenzo Martínez 123").resultado, Retorno.Resultado.OK, "Se registra el cliente: Micaela Pérez");
        p.ver(s.agregarCliente("Romina Álvarez", "222", 98999111, "Carlos Quijano 222").resultado, Retorno.Resultado.OK, "Se registra el cliente: Romina Álvarez");
        p.ver(s.agregarCliente("Felipe Muñoz", "333", 97333333, "Luis Franzini 333").resultado, Retorno.Resultado.OK, "Se registra el cliente: Felipe Muñoz");
        p.ver(s.agregarCliente("Pedro González", "111", 94222222, "Mercedes 888").resultado, Retorno.Resultado.ERROR_1, "Ya existe un cliente con rut 111");
        p.ver(s.agregarCliente("Pedro González", "444", 94222222, "Mercedes 888").resultado, Retorno.Resultado.OK, "Se registra el cliente: Pedro González");
        ...
        p.ver(s.agregarCliente("Nicole Bañales", "222", 92323111, "Carlos Berg 934").resultado, Retorno.Resultado.ERROR_1, "Ya existe un cliente con rut 222");
    ...
    public static void pruebasRegistroCamion(Obligatorio s, Prueba p) {
        p.ver(s.agregarCamion("MEC4452", 2000).resultado, Retorno.Resultado.OK, "Se registra el camión de matrícula MEC4452");
        p.ver(s.agregarCamion("OOO1111", 4000).resultado, Retorno.Resultado.OK, "Se registra el camión de matrícula OOO1111");
        p.ver(s.agregarCamion("WEC3234", 3000).resultado, Retorno.Resultado.OK, "Se registra el camión de matrícula WEC3234");
        p.ver(s.agregarCamion("MEC4452", 1000).resultado, Retorno.Resultado.ERROR_1, "No se registra. Ya existe un camión de matrícula MEC4452");
        p.ver(s.agregarCamion("TTT4500", 1000).resultado, Retorno.Resultado.OK, "Se registra el camión de matrícula TTT4500");
        p.ver(s.agregarCamion("IOE2893", 0).resultado, Retorno.Resultado.ERROR_2, "No se registra. La carga del camion es <= 0");
        p.ver(s.agregarCamion("COC3100", 3000).resultado, Retorno.Resultado.OK, "Se registra el camión de matrícula COC3100");
    ...
    public static void pruebasRegistroProducto(Obligatorio s, Prueba p) {
        ...
        p.ver(s.registrarProducto("Televisión Marc", "Televisión de 32 pulgadas").resultado, Retorno.Resultado.OK, "Se registra el producto Televisión Marc");
        p.ver(s.registrarProducto("Monopatin", "Monopatn para niños").resultado, Retorno.Resultado.OK, "Se registra el producto Monopatin");
        ...
        p.ver(s.registrarProducto("Laptop Stu", "").resultado, Retorno.Resultado.ERROR_3, "No se registra. La descripción esta vacía");
    ...
    public static void pruebasAltaSotck(Obligatorio s, Prueba p) {
        ...
        s.getFabrica().setCapacidadCajas(3001);
        ...
        p.ver(s.altaDeStockDeProducto("MEC4452", 8, 70, 1000).resultado, Retorno.Resultado.ERROR_2, "No se registra. No existe el producto de código 8");
        ...
        p.ver(s.altaDeStockDeProducto("OOO1111", 5, 17, 50).resultado, Retorno.Resultado.OK, "Se agregan 50 unidades de stock al producto Laptop Stu");
        ...
        p.ver(s.altaDeStockDeProducto("TTT4500", 4, 99, 30).resultado, Retorno.Resultado.OK, "Se agregan 30 unidades de stock al producto Monopatin");

        p.ver(s.altaDeStockDeProducto("WEC3234", 2, 50, 90).resultado, Retorno.Resultado.ERROR_4, "No se registra. El número de caja 50 ya existe");
        p.ver(s.altaDeStockDeProducto("TTT4500", 4, 108, 10).resultado, Retorno.Resultado.OK, "Se agregan 10 unidades de stock al producto Televisión Marc");
        p.ver(s.altaDeStockDeProducto("TTT4500", 4, 109, 10).resultado, Retorno.Resultado.OK, "Se agregan 10 unidades de stock al producto Televisión Marc");
        p.ver(s.altaDeStockDeProducto("TTT4500", 4, 110, 10).resultado, Retorno.Resultado.OK, "Se agregan 10 unidades de stock al producto Televisión Marc");
        // necesario para testear
        s.getFabrica().setCapacidadCajas(9);
...
//        s.getFabrica().getListaEntregasPendientes().mostrar();
    ...
    public static void pruebasDeBaja(Obligatorio s, Prueba p) {
        ...
        p.ver(s.eliminarCamion("COC3100").resultado, Retorno.Resultado.OK, "Se elimina el camión COC3100");
    ...
    public static void pruebasDeReporteDeEnviosXProducto(Obligatorio s, Prueba p) {
        ...
        p.ver(s.reporteDeEnviosDeProductos().resultado, Retorno.Resultado.OK, "Se muestra el reporte de evíos por productos");
